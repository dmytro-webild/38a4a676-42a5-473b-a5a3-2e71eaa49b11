...
export default function LandingPage() {
      ...
      testimonials={[
        {
          ...
          name: "Elena Vance",
          handle: "@elena.v",
          testimonial: "The Wagyu Ribeye changed my life. Absolutely spectacular.",
          rating: 5,
        ...
        },
        {
          id: "t2",
          name: "Julian Thorne",
          handle: "@thorne_travels",
          testimonial: "Unparalleled service and incredible wine pairing.",
          rating: 5,
        ...
        },
        {
          ...
          name: "Marcus Reid",
          handle: "@reid_reviews",
          testimonial: "A sanctuary for fine food lovers. Highly recommended.",
          rating: 5,
        ...
        },
        {
          ...
          name: "Sarah Chen",
          handle: "@sarah_chen",
          testimonial: "Sophisticated atmosphere and truly inventive flavors.",
          rating: 5,
        ...
        },
        {
          ...
          name: "David Miller",
          handle: "@dmiller",
          testimonial: "The best dining experience in the city. Incredible.",
          rating: 5,
      ...
      faqs={[
        {
          ...
          content: "Yes, we provide an extensive vegan and vegetarian menu crafted daily.",
        },
        {
          id: "q2",
          title: "What is the dress code?",
          content: "We maintain a business-formal dress code to honor our dining atmosphere.",
        },
        {
          id: "q3",
          title: "Is parking available?",
          content: "Valet service is available directly at the entrance for all guests.",
        },
      ]}
  ...
  <div id="contact" data-section="contact">
      ...
      buttons={[
        {
          text: "Contact Us",
          href: "mailto:reserve@lumiere.com",
        },
      ]}
    />
  </div>
